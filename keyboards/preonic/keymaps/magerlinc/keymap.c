...
void keyboard_post_init_user(void) {
  ...
  rgblight_sethsv_noeeprom(RGB_MAGENTA);
...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTRL, RGB_MOD, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_preonic_grid(
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    DK_OE,    DK_AA,
